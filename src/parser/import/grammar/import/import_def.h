...
#include "import.h"
#include "parser/import/grammar/common/common_def.h"
...
namespace import {
    namespace parser {
        ...
        x3::rule<class node_id_str, std::string> node_id_import = "node_id_import";

        // Grammar
        auto const end = (eol|eoi);

        auto const anon =
            lexeme[char_("_") >> char_("Aa") >> char_("1-9") >> *char_("0-9")];

        auto const node_id_import_def =
            node_name | anon;
